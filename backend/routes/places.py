...
def get_places():
    ...
    radius = request.args.get("radius", "5000")  # Radio en metros

    # Consulta a Overpass API
    url = f"https://overpass-api.de/api/interpreter?data=[out:json];node[amenity=tourism](around:{radius},{lat},{lng});out;"
